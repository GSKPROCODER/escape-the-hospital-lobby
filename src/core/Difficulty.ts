...
export const DIFFICULTIES: Record<DifficultyId, DifficultyConfig> = {
  easy: {
    ...
    lives: -1,
    enemy: { sightRange: 10, fovDeg: 90, patrolSpeed: 1.6, chaseSpeed: 4.5, giveUpTime: 3, hearingRadius: 4, catchRadius: 1.2 },
  },
  normal: {
    id: 'normal',
    label: 'Normal',
    ...
    lives: 5,
    enemy: { sightRange: 16, fovDeg: 100, patrolSpeed: 2.0, chaseSpeed: 5.5, giveUpTime: 6, hearingRadius: 7, catchRadius: 1.2 },
  },
  nightmare: {
    id: 'nightmare',
    label: 'Nightmare',
    ...
    lives: 2,
    enemy: { sightRange: 24, fovDeg: 120, patrolSpeed: 2.6, chaseSpeed: 6.5, giveUpTime: 12, hearingRadius: 11, catchRadius: 1.3 },
  },
};
